...
import com.fanwe.library.listener.SDAnimatorCreateListener;
...
public class SDAnimationUtil
{
    ...
    public static ObjectAnimator translateTopToBottom(View view)
    {
        if (view != null)
        {
            int viewY = SDViewUtil.getViewYOnScreen(view) - SDViewUtil.getStatusBarHeight();
            int viewHeight = SDViewUtil.getViewHeight(view);
            int screenHeight = SDViewUtil.getScreenHeight();
    ...
    public static AnimatorSet playSequentially(View target, String propertyName, SDAnimatorCreateListener listener, float... values)
    {
