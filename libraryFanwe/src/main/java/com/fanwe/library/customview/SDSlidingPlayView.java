...
public class SDSlidingPlayView extends LinearLayout
{
    ...
    {
        vpg_content.setMeasureMode(SDViewPager.MeasureMode.NORMAL);
        SDViewUtil.setViewHeightMatchParent(vpg_content);
    }

    public void setContentWrapContent()
    {
        vpg_content.setMeasureMode(SDViewPager.MeasureMode.MAX_CHILD);
        SDViewUtil.setViewHeightWrapContent(vpg_content);
    }
    ...
    private void init()
    {
        ...
        SDViewUtil.setViewHeight(ll_blur, SDViewUtil.dp2px(20));
    ...
    private void changeBottomViewByData()
    {
        ...
        switch (mode)
        {
            ...
            case NUMBER:
                ...
                ll_blur.setBackgroundColor(SDResourcesUtil.getColor(R.color.blur));
