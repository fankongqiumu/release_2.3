...
public class AuctionRealGoodsDialogView extends BaseAppView
{
    ...
    private void bindAdapterPodCast()
    {
         ...
         * 设为拍品
         */
        adapter.setClickAuctionListener(new SDAdapter.ItemClickListener<App_shop_paigoodsItemModel>()
        {
            @Override
            public void onClick(int position, App_shop_paigoodsItemModel item, View view)
            {
