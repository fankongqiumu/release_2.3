...
public class AuctionGoodsDetailActivity extends BaseActivity
{
    ...
    @ViewInject(R.id. ll_text_detail)
    private LinearLayout ll_text_detail;
    ...
    private void register()
    {
        ...
        ll_text_detail.setOnClickListener(this);
    }
    ...
    private void bindData(App_pai_user_goods_detailActModel actModel)
    {
        if (actModel.getData() != null && actModel.getData().getInfo() != null)
        {
            ...
            if (is_true == 1)
            {
                ...
                {
                    SDViewUtil.show(ll_pai_detail);
                } else
                {
                    SDViewUtil.hide(ll_pai_detail);
                }
            } else
            {
            ...
            if (!is_anchor)
            {
                ...
                if (info.getStatus() == 0)
                {
                    ...
                    if (actModel.getData().getHas_join() == 1)
                    {
                        ...
                        SDViewUtil.replaceView(ll_bot_status, hasjoin1);
                    } else
                    {
                        ...
                        SDViewUtil.replaceView(ll_bot_status, hasjoin0);
    ...
    private void isShowPaiDetail()
    {
        if (isShow)
        {
            ...
            SDViewUtil.hide(ll_iv_content);
            SDViewUtil.hide(tv_pai_detail);
            isShow = false;
        } else
        {
            ...
            if (is_true == 1)
            {
                SDViewUtil.show(ll_iv_content);
            } else
            {
                SDViewUtil.show(tv_pai_detail);
