...
{
    private ItemClickListener<App_shop_paigoodsItemModel> clickToDetailListener;
    private ItemClickListener<App_shop_paigoodsItemModel> clickAuctionListener;

    public void setClickToDetailListener(ItemClickListener<App_shop_paigoodsItemModel> clickToDetailListener)
    {
        this.clickToDetailListener = clickToDetailListener;
    }

    public void setClickAuctionListener(ItemClickListener<App_shop_paigoodsItemModel> clickAuctionListener)
    {
    ...
    public void bindData(final int position, View convertView, ViewGroup parent, final App_shop_paigoodsItemModel model)
    {
        ...
        tv_set_auction.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                {
                    clickAuctionListener.onClick(position, model, view);
                }
            }
        });
    }
