...
public class ShopPodcastMyStoreView extends BaseAppView
{
    ...
    private void bindAdapter()
    {
         ...
         * 编辑购物商品
         */
        adapter.setClickEditCartListener(new SDAdapter.ItemClickListener<App_shop_mystoreItemModel>()
        {
            @Override
         ...
         * 删除购物商品
         */
        adapter.setClickDelGoodListener(new SDAdapter.ItemClickListener<App_shop_mystoreItemModel>()
        {
            @Override
            public void onClick(int position, App_shop_mystoreItemModel item, View view)
            {
