...
public class ShopMyStoreView extends BaseAppView
{
    ...
    private void bindAdapterPodCast()
    {
         ...
         * 跳转至详情页
         */
        adapter.setItemClickListener(new SDAdapter.ItemClickListener<App_shop_mystoreItemModel>()
        {
            @Override
            public void onClick(int position, App_shop_mystoreItemModel item, View view)
            {
         ...
         * 推送
         */
        adapter.setClickPushListener(new SDAdapter.ItemClickListener<App_shop_mystoreItemModel>()
        {
            @Override
            public void onClick(int position, App_shop_mystoreItemModel item, View view)
            {
    ...
    {
        ShopCommonInterface.requestShopGoodsUrl(goods_id, Integer.parseInt(createrId), new AppRequestCallback<App_pai_user_open_goods_urlActModel>()
        {
            @Override
