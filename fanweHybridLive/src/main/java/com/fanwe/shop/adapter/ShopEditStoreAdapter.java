...
{
    private SDAdapter.ItemClickListener<App_shop_mystoreItemModel> clickEditCartListener;
    private SDAdapter.ItemClickListener<App_shop_mystoreItemModel> clickDelGoodListener;
    private List<App_shop_mystoreItemModel> listModel;

    public void setClickEditCartListener(SDAdapter.ItemClickListener<App_shop_mystoreItemModel> clickEditCartListener)
    {
        this.clickEditCartListener = clickEditCartListener;
    }

    public void setClickDelGoodListener(SDAdapter.ItemClickListener<App_shop_mystoreItemModel> clickDelGoodListener)
    {
