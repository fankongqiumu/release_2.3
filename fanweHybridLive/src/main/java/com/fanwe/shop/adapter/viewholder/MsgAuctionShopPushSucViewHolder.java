...
public class MsgAuctionShopPushSucViewHolder extends MsgViewHolder
{
    ...
    private void requestGoodsUrl(int goods_id, String createrId)
    {
        ShopCommonInterface.requestShopGoodsUrl(String.valueOf(goods_id), Integer.parseInt(createrId), new AppRequestCallback<App_pai_user_open_goods_urlActModel>()
        {
            @Override
