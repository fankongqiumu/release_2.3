...
public class ShopCommonInterface
{
     ...
     * @param listener
     */
    public static void requestShopGoodsUrl(String goods_id, int podcast_id, AppRequestCallback<App_pai_user_open_goods_urlActModel> listener)
    {
        AppRequestParams params = new AppRequestParams();
     ...
     * @param listener
     */
    public static void requestShopGoodsUrl(int goods_id, int podcast_id, AppRequestCallback<App_pai_user_open_goods_urlActModel> listener)
    {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("pai_user");
        params.putAct("open_goods_detail");
