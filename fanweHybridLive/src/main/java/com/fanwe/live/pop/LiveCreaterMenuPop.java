...
import com.fanwe.library.adapter.SDAdapter.ItemClickListener;
...
public class LiveCreaterMenuPop extends SDPopupWindow
{
    ...
    private ItemClickListener<LiveCreaterMenuModel> listenerItemClick;

    public void setListenerItemClick(ItemClickListener<LiveCreaterMenuModel> listenerItemClick)
    {
    ...
    private void init()
    {
        ...
        adapter.setItemClickListener(new ItemClickListener<LiveCreaterMenuModel>()
        {
            ...
            public void onClick(int position, LiveCreaterMenuModel item, View view)
            {
                if (item.isEnable())
                {
                    ...
                    {
                        listenerItemClick.onClick(position, item, view);
                    }
                }
            }
        });
