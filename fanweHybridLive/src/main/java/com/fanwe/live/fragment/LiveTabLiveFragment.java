...
public class LiveTabLiveFragment extends BaseFragment
{
    ...
    private void initTabs()
    {
        ...
        // 最新
        String tab_new_text = getString(R.string.live_tab_new_text);
        tab_live_new.setTextTitle(tab_new_text);
        tab_live_new.getViewConfig(tab_live_new.mIvUnderline).setBackgroundColorNormal(Color.TRANSPARENT).setBackgroundColorSelected(SDResourcesUtil.getColor(R.color.main_color));
        tab_live_new.getViewConfig(tab_live_new.mTvTitle).setTextColorNormal(SDResourcesUtil.getColor(R.color.text_title_bar)).setTextColorSelected(SDResourcesUtil.getColor(R.color.text_black));
