...
import static com.fanwe.live.common.AppRuntimeWorker.getApp_id_tencent_live;
...
public class CommonInterface
{
    ...
    public static void requestMyUserInfo(AppRequestCallback<App_userinfoActModel> listener)
    {
        ...
        requestUserInfo(null, null, 0, new AppRequestCallbackWrapper<App_userinfoActModel>(listener)
        {
            @Override
            protected void onSuccess(SDResponse resp)
            {
     ...
     * @param room_id    房间ID(查询用户在房间内对应主播的关系)
     * @param listener
     */
    public static void requestUserInfo(String podcast_id, String to_user_id, int room_id, AppRequestCallback<App_userinfoActModel> listener)
    {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("user");
     ...
     *
     * @param room_id      房间id
     * @param watch_number 实际观看人数
     * @param vote_number  印票数量
     * @param lianmai_num  连麦数量
     * @param live_quality 直播质量
     * @param listener
     */
    public static SDRequestHandler requestMonitor(int room_id,
            int watch_number,
            long vote_number,
            int lianmai_num,
            String live_quality,
            AppRequestCallback<App_monitorActModel> listener
    )
    {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("video");
        ...
        params.put("vote_number", vote_number);
        params.put("lianmai_num", lianmai_num);
        params.put("live_quality", live_quality);
        return AppHttpUtil.getInstance().post(params, listener);
    }

    public static SDRequestHandler requestEndVideo(int room_id, String video_url, AppRequestCallback<App_end_videoActModel> listener)
    {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("video");
     ...
     * @param listener
     */
    public static SDRequestHandler requestRoomInfo(int room_id, int is_vod, int type, int has_scroll, int sex, int cate_id, String city, String private_key, AppRequestCallback<App_get_videoActModel> listener)
    {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("video");
        ...
        params.put("has_scroll", has_scroll);
        params.put("sex", sex);
        params.put("cate_id", cate_id);
        params.put("city", city);
        params.put("private_key", private_key);

        String tencent_app_id = getApp_id_tencent_live();
        ...
        //params.put("sign_version",getAppSignVersion());
        return AppHttpUtil.getInstance().post(params, listener);
    }
     ...
     * @param listener
     */
    public static void requestUpdateLiveState(int room_id,
            String group_id,
            String channelid,
            String play_rtmp,
            String play_flv,
            String play_hls,
            int status,
            AppRequestCallback<App_video_cstatusActModel> listener
    )
    {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("video");
        ...
        if (play_rtmp != null)
        {
            params.put("play_rtmp", play_rtmp);
        }
        if (play_flv != null)
        {
            params.put("play_flv", play_flv);
        }
        if (play_hls != null)
        {
            params.put("play_hls", play_hls);
        }
     ...
     * @param listener
     */
    public static void requestInitPlugins(AppRequestCallback<App_InitGamesActModel> listener)
    {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("app");
     ...
     * @param listener
     */
    public static SDRequestHandler requestStartPlugin(String pluginId, AppRequestCallback<App_startGameActModel> listener)
    {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("games");
        params.putAct("start");
     ...
     * @param listener
     */
    public static void requestDoBet(int gameId, int coins, int betType, AppRequestCallback<App_betGamesActModel> listener)
    {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("games");
        params.putAct("bet");
        params.put("id", gameId);
        params.put("money", coins);
        params.put("bet", betType);
        AppHttpUtil.getInstance().post(params, listener);
    }
     ...
     * @param listener
     */
    public static void requestGamesLog(String game_id, String podcast_id, AppRequestCallback<App_GamesLogActModel> listener)
    {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("games");
        params.putAct("log");
     ...
     * @param listener
     */
    public static void requestPlugin_status(String id, AppRequestCallback<App_plugin_statusActModel> listener)
    {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("app");
     ...
     *
     * @param desc 错误描述
     *             在{@link AppRequestCallback#onError(SDResponse)}中调用
     */
