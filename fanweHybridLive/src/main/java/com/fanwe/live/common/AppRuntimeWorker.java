...
public class AppRuntimeWorker
{
     ...
     * @return 是否展示星店 小店插件
     */
    public static int getIsViewerShowPlug()
    {
    ...
    public static int getVideoResolutionType()
    {
        ...
        {
            return LiveConstant.VideoResolutionType.VIDEO_RESOLUTION_TYPE_360_640;
        }
    }
    ...
    {
        String sign_version = SDResourcesUtil.getResources().getString(R.string.sign_version);
        return sign_version;
    }
    ...
    /**
     * @return App_id_tencent_live
     */
    public static String getApp_id_tencent_live()
    {
        String app_id_tencent_live = SDResourcesUtil.getString(R.string.app_id_tencent_live);
        return app_id_tencent_live;
    }
    ...
    {
        InitActModel initActModel = InitActModelDao.query();
        return initActModel != null && initActModel.getOpen_vip() == 1;
    }

    public static boolean useGameCoin()
    {
        InitActModel initActModel = InitActModelDao.query();
        return initActModel != null && initActModel.getOpen_diamond_game_module() == 0&&initActModel.getOpen_game_module()==1;
    }

    public static boolean isOpenSendCoinsModule()
    {
        InitActModel initActModel = InitActModelDao.query();
        return initActModel != null && initActModel.getOpen_send_coins_module() == 1;
    }
    ...
    {
        InitActModel initActModel = InitActModelDao.query();
        return initActModel != null && initActModel.getOpen_banker_module() == 1;
    }
    ...
    public static void startPlayback(final PlayBackData data, final Activity activity)
    {
        ...
        LiveNetChecker.check(activity, new LiveNetChecker.CheckResultListener()
        {
            ...
            {
                if (data.getCreate_type() == 0)
                {
                    //移动端回放
                    startPlaybackInside(data, activity);
                } else if (data.getCreate_type() == 1)
                {
                    //PC端回放

//                    startPCPlayBack(data, activity);
                    startPlaybackInside(data, activity);
                }
            }
        ...
        LiveNetChecker.check(activity, new LiveNetChecker.CheckResultListener()
        {
            ...
            public void onAccepted()
            {
                ...
                } else if (data.getCreate_type() == 1)
                {
                    ...
                    joinPushLiveInside(data, activity);
                    //PC端直播
//                    joinPushPCLiveInside(data, activity);
                }
            }
    ...
    public static void joinRoom(LiveRoomModel model, Activity activity)
    {
        ...
        if (model.getLive_in() == 1)
        {
            ...
            data.setType(0);
            data.setVideoType(model.getVideo_type());
