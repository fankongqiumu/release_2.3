...
public class LiveFamilysListActivity extends BaseTitleActivity implements LiveSongSearchView.SearchViewListener
{
    ...
    private void initView()
    {
         ...
         * 家族详情
         */
        adapter.setClickItemListener(new SDAdapter.ItemClickListener<App_family_listItemModel>()
        {
            @Override
            public void onClick(int position, App_family_listItemModel item, View view)
            {
