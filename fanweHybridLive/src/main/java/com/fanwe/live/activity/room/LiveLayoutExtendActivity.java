...
public class LiveLayoutExtendActivity extends LiveLayoutGameExtendActivity implements AuctionBusiness.AuctionBusinessListener, ShopBusiness.ShopBusinessListener
{
    ...
    {
        return auctionBusiness.isAuctioning();
    }
    ...
    protected void changeAvVideoGlviewLayout()
    {
        ...
        SDViewUtil.setViewHeight(find(R.id.view_video), SDViewUtil.getScreenHeight() / 3);
        SDViewUtil.setViewWidth( find(R.id.view_video), SDViewUtil.getScreenWidth() / 3);
        SDViewUtil.hide(fl_live_goods_push);
    }

    protected void revertAvVideoGlviewLayout()
    {
        SDViewUtil.show(roomInfoView);
        SDViewUtil.setViewHeight(find(R.id.view_video), SDViewUtil.getScreenHeight());
        SDViewUtil.setViewWidth(find(R.id.view_video), SDViewUtil.getScreenWidth());
        SDViewUtil.show(fl_live_goods_push);
    }
