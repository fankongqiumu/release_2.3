...
public class LiveSociatySearchJoinActivity extends BaseTitleActivity implements LiveSongSearchView.SearchViewListener
{
    ...
    private void initView()
    {
         ...
         * 家族详情
         */
        adapter.setItemClickListener(new SDAdapter.ItemClickListener<App_sociaty_listItemModel>()
        {
            @Override
            public void onClick(int position, App_sociaty_listItemModel item, View view)
            {
