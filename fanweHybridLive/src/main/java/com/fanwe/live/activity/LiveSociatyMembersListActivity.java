...
public class LiveSociatyMembersListActivity extends BaseTitleActivity
{
    ...
    private void initTabs()
    {
        ...
        tab_live_logout.getViewConfig(tab_live_apply.mIvUnderline).setBackgroundColorNormal(Color.TRANSPARENT).setBackgroundColorSelected(SDResourcesUtil.getColor(R.color.main_color));
        tab_live_logout.getViewConfig(tab_live_apply.mTvTitle).setTextColorNormal(SDResourcesUtil.getColor(R.color.text_gray)).setTextColorSelected(SDResourcesUtil.getColor(R.color.main_color));
