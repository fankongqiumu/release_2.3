...
public class LiveUserHomeActivity extends BaseActivity
{
    ...
    private TextView tv_use_diamonds;// 消费钻石
...
//            data.setCreaterId(video.getUser_id());
//            data.setGroupId(video.getGroup_id());
//            data.setLoadingVideoImageUrl(video.getLive_image());
//            data.setRoomId(video.getRoom_id());
//            data.setType(0);
//            data.setVideoType(video.getVideo_type());
//            data.setCreate_type(video.getCreate_type());
//            AppRuntimeWorker.joinLive(data, this);
//        } else if (video.getLive_in() == 3) {
//            PlayBackData data = new PlayBackData();
//            data.setRoomId(video.getRoom_id());
//            AppRuntimeWorker.startPlayback(data, this);
//        }
    }
        ...
        if (user != null)
        {
            ...
            if(!isSelf) {
                if(actModel.getVideo() != null) {
                    SDViewUtil.show(ll_broadcast_entrance);
                    ...
                    SDViewUtil.invisible(ll_broadcast_entrance);
            }
