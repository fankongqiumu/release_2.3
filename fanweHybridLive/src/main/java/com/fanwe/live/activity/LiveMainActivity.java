...
import com.fanwe.live.fragment.LiveTabNoticeFragment;
...
public class LiveMainActivity extends BaseActivity {
    ...
    @ViewInject(R.id.view_tab_livet)
    private LiveTabMainMenuView view_tab_livet;
    @ViewInject(R.id.iv_tab_create_live)
    private View view_tab_create_live;


    @ViewInject(R.id.view_tab_met)
    private LiveTabMainMenuView view_tab_met;
    ...
    private void initTabs() {
        ...
        selectViewManager.setReSelectListener(new SDSelectManager.ReSelectListener<LiveTabMainMenuView>() {
            @Override
        ...
        selectViewManager.setListener(new SDSelectViewManager.SDSelectManagerListener<LiveTabMainMenuView>() {
            ...
            public void onNormal(int index, LiveTabMainMenuView item) {
                switch (index) {
                    ...
                    case 1:
                        item.iv_tab_image.setImageResource(R.drawable.ic_live_tab_ranking_normal );
                        break;
                    case 2:
                        item.iv_tab_image.setImageResource(R.drawable.ic_live_tab_notice_normal);
                        break;
            ...
            public void onSelected(int index, LiveTabMainMenuView item) {
                switch (index) {
                    ...
                    case 1:
                        ...
                        item.iv_tab_image.setImageResource(R.drawable.ic_live_tab_ranking_selected);
                        break;
                    case 2:
                        clickTabNotice();
                        item.iv_tab_image.setImageResource(R.drawable.ic_live_tab_notice_selected);
                        break;
                    case 3:
                        clickTabMe();
        ...
        LiveTabMainMenuView[] items = new LiveTabMainMenuView[]{view_tab_live,view_tab_livet,view_tab_met, view_tab_me};
    ...
    protected void clickTabNotice() {
        getSDFragmentManager().toggle(R.id.fl_main_content, null, LiveTabNoticeFragment.class);
    }
