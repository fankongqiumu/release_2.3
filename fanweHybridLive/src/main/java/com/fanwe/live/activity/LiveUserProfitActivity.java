...
//        tv_take_reward_wx.setTextColor(SDDrawable.getStateListColor(getResources().getColor(R.color.main_color),getResources().getColor(R.color.white)));
        tv_auction_manage.setTextColor(SDDrawable.getStateListColor(SDResourcesUtil.getColor(R.color.main_color),SDResourcesUtil.getColor(R.color.white)));
        tv_sell_detail.setTextColor(SDDrawable.getStateListColor(SDResourcesUtil.getColor(R.color.main_color),SDResourcesUtil.getColor(R.color.white)));
            ...
            protected void onSuccess(SDResponse resp) {
                if(actModel.isOk()) {
                    ...
                    if(withdrawals_alipay == 1) {
                        SDViewUtil.show(tv_take_reward_alipay);
                    } else {
                        SDViewUtil.hide(tv_take_reward_alipay);
                    }

                    if(withdrawals_wx == 1) {
                        SDViewUtil.show(tv_take_reward_wx);
                    } else {
                        SDViewUtil.hide(tv_take_reward_wx);
                    }
