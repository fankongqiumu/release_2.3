...
{
    private ItemClickListener<App_family_listItemModel> clickItemListener;
    private boolean isApply = true;

    public void setClickItemListener(ItemClickListener<App_family_listItemModel> clickItemListener)
    {
...
//            txv_add_fam.setEnabled(true);
        ...
        ll_all.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                {
                    clickItemListener.onClick(position, model, view);
                }
            }
        });
