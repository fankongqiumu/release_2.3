...
{
    private ItemClickListener<PayItemModel> mListenerItem;
    ...
    public void bindData(final int position, final View convertView, final ViewGroup parent, final PayItemModel model)
    {
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mListenerItem.onClick(position, model, convertView);
            }
        });
    }

    public void setOnItemClickListener(ItemClickListener<PayItemModel> listener) {
