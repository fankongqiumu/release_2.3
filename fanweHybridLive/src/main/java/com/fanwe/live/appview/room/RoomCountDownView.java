...
public class RoomCountDownView extends RoomView
{
    ...
    public void startCountDown(int number)
    {
        ...
        SDAnim animX = SDAnim.from(tv_number).setScaleX(5, 0).setDuration(1000).setRepeatCount(number - 1).addListener(new AnimatorListenerAdapter()
        {
            @Override
        ...
        SDAnim animY = SDAnim.from(tv_number).setScaleY(5, 0).setDuration(1000).setRepeatCount(number - 1);
