...
public class RoomPCPlaybackLandControlView extends ARoomPCPlaybackBaseControlView {

    public RoomPCPlaybackLandControlView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public RoomPCPlaybackLandControlView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public RoomPCPlaybackLandControlView(Context context) {
        super(context);
    }
    ...
    protected int onCreateContentView() {
        return R.layout.view_room_pc_playback_land_control;
    }
...
//        iv_pc_gift.setOnClickListener(this);
    ...
    protected void initAnimators() {
        float top_height = SDViewUtil.getViewHeight(ll_control_view_top);
        float bottom_height = SDViewUtil.getViewHeight(ll_control_view_bottom);
        float right_width = SDViewUtil.getViewWidth(ll_control_view_right);
    ...
    private void initTitle() {
        tv_pc_title.setText(getLiveInfo().getRoomInfo().getTitle());
    }
