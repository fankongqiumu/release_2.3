...
public class RoomPrivateRemoveViewerView extends RoomView implements OnItemClickListener
{
    ...
    protected int onCreateContentView() {
        return R.layout.frag_live_private_remove_viewer;
    }
        ...
        CommonInterface.requestPrivateRoomFriends(room_id, page, new AppRequestCallback<Video_private_room_friendsActModel>() {
            ...
            protected void onFinish(SDResponse resp) {
                ...
                if(mAdapter.getCount() > 0) {
                    SDViewUtil.hide(ll_no_viewers_tips);
                } else {
                    SDViewUtil.show(ll_no_viewers_tips);
                }
            }
        });
    }
    ...
    private void requestRemoveViewer() {
        ...
        CommonInterface.requestPrivateDropUser(room_id,getUserIds(mListSelected),new AppRequestCallback<BaseActModel>() {
