...
public class GiftAnimatorRocket1 extends GiftAnimatorView
{
    ...
    private void testAnim()
    {
        ...
        SDAnimSet set = SDAnimSet.from(fl_rocket_root)
                //火箭淡入
                .setAlpha(0, 1f).setDuration(1000)
                ...
                .delay(500)
                //数字倒数
                .with(tv_number).setScaleX(1f, 0f).setRepeatCount(2).setDuration(1000)
                .with().setScaleY(1f, 0f).setRepeatCount(2).setDuration(1000)
                .addListener(new AnimatorListenerAdapter()
                {
                    @Override
                    public void onAnimationStart(Animator animation)
                ...
                //火箭起飞
                .next(fl_rocket_root).setY(rocketY1, rocketY2).setDuration(3000).setAccelerate()
                .addListener(new AnimatorListenerAdapter()
                {
                    @Override
                    public void onAnimationStart(Animator animation)
                ...
                //烟雾淡入
                .with(iv_rocket_smoke).setAlpha(0, 1f).setDuration(3000).setStartDelay(500)
                //烟雾淡出
                .next().setAlpha(1f, 0).setDuration(500)
                .addListener(new AnimatorListenerAdapter()
                {
                    @Override
                    public void onAnimationEnd(Animator animation)
        ...
        getAnimatorSet().play(set.getSet());
    }
