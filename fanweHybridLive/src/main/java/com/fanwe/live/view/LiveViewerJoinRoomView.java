...
public class LiveViewerJoinRoomView extends LinearLayout
{
    ...
    private void playIn()
    {
        ...
        {
            ObjectAnimator inTranslationX = ObjectAnimator.ofFloat(this, "translationX", -SDViewUtil.getViewWidth(this), 0f);
    ...
    private void playOut()
    {
        ...
        {
            ObjectAnimator outTranslationY = ObjectAnimator.ofFloat(this, "translationY", 0f, -SDViewUtil.getViewHeight(this));
