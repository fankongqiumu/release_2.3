...
public class PayBalanceActivity extends BaseActivity
{
    ...
    private void initTabs()
    {
        ...
        tab_pay_time.getViewConfig(tab_pay_time.mTvTitle).setTextColorNormal(SDResourcesUtil.getColor(R.color.text_title_bar)).setTextColorSelected(SDResourcesUtil.getColor(R.color.main_color))
        ...
        tab_pay_scene.getViewConfig(tab_pay_scene.mTvTitle).setTextColorNormal(SDResourcesUtil.getColor(R.color.text_title_bar)).setTextColorSelected(SDResourcesUtil.getColor(R.color.main_color))
                .setTextSizeNormal(SDResourcesUtil.getDimensionPixelSize(R.dimen.base_textsize_18)).setTextSizeSelected(SDResourcesUtil.getDimensionPixelSize(R.dimen.base_textsize_18));
        ...
        {
            SDViewUtil.hide(tab_pay_time);
        }

        if (AppRuntimeWorker.getLive_pay_scene() == 0)
        {
            SDViewUtil.hide(tab_pay_scene);
        }
