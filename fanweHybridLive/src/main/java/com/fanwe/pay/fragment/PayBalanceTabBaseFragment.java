...
public class PayBalanceTabBaseFragment extends BaseFragment
{
    ...
    private void addTab()
    {
        ...
        tab_left.getViewConfig(tab_left.mTvTitle).setTextColorNormalResId(R.color.text_black).setTextColorSelectedResId(R.color.main_color);
        ...
        tab_right.getViewConfig(tab_right.mTvTitle).setTextColorNormalResId(R.color.text_black).setTextColorSelectedResId(R.color.main_color);
